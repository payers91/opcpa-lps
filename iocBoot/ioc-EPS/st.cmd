...
dbLoadRecords("iocSoft.db", "IOC=PLC:EPS")
dbLoadRecords("save_restoreStatus.db", "P=PLC:EPS:")
dbLoadRecords("caPutLog.db", "IOC=${IOC}")

## TwinCat System Databse files ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:EPS")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:EPS")
...
save_restoreSet_status_prefix( "PLC:EPS:" )
